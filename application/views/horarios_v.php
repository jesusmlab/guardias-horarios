...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="panel panel-primary">
            ...
            ?>
            <div class="panel-heading">Horario de <?php echo $profsel; ?>
                <?
                if ($prof_corr!=""){
                ?>
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <select id="cmbprofesor" autofocus data-live-search="true" class="form-control selectpicker">
                                <?php
                            ...
                            for ($ind = 0; $ind < $nfilas; $ind++) {
                                if (is_array($casillas[$fila][$tramo][$ind])) {
                                    ...
                                    if ($casillas[$fila][$tramo][$ind]['Unidad'] != "") {
                                        $tabla .= "<strong>Grupo&nbsp&nbsp:<a target='_blank' href='" . base_url() . "horarios/mostrar_grupo/" . $casillas[$fila][$tramo][$ind]['Unidad'] . "'>" . $casillas[$fila][$tramo][$ind]['Unidad'] . "</a></strong><br/>";
                                    }

                                    if ($casillas[$fila][$tramo][$ind]['Aula'] != "") {
                                        $tabla .= "<strong>Aula&nbsp&nbsp&nbsp&nbsp&nbsp:<a target='_blank' href='" . base_url() . "horarios/mostrar_aula/" . $casillas[$fila][$tramo][$ind]['Aula'] . "'>" . $casillas[$fila][$tramo][$ind]['Aula'] . "</a></strong>";
                ...
                <table class="table peque table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach ($estadisA as $item) {
                            $tabla .= "<tr>";
                            $tabla .= "<td>" . $item['Actividad'] . "</td>";
                            $tabla .= "<td>" . $item['numero'] . "</td>";
                            $tabla .= "</tr>";
                        }
                        echo $tabla;
                        ?>
...
<script>
    ...
    $("#cmbprofesor").on("change", function(evento) {
        location.href = "<? echo base_url(); ?>horarios/mostrar/" + this.value;
    })
</script>